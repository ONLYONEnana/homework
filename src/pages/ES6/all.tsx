...
const allData = {
  ...
  'app.versionMismatchAlert.title': 'Ambari服务器 / Web 客户端版本不匹配',
  'app.versionMismatchAlert.body':
    'Ambari服务器和Web客户端版本不匹配:<br> ' +
  ...
  'login.error.bad.connection':
    '无法连接到Datatom服务器。确认Datatom服务器正在运行，您可以从这台机器访问Datatom服务器。',
  ...
  'installer.step9.hosts.status.label.warning': '警报',
  ...
  'menu.item.dashboard': '监控',
  'menu.item.services': '服务',
  'menu.item.hosts': '主机',
  'menu.item.admin': '管理',
  'menu.item.alerts': '警报',
  'menu.item.define': '自定义',
  'menu.item.others': '其他菜单',
